      ...
      <nav className="aside__menu menu">
        <ul className="menu__list">
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/home') ? 'menu__list-link--active' : ''}`} to="/home">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/jobs') ? 'menu__list-link--active' : ''}`} to="/jobs">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18 14H10" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M15 18H10" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 6H18V10H10V6Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span>Browse Jobs</span>
            </Link>
            <div className="popup_menu">Browse Jobs</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/subscription') ? 'menu__list-link--active' : ''}`} to="/subscription">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="popup_menu">Pro Subscription</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/projects') ? 'menu__list-link--active' : ''}`} to="/projects">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="popup_menu">Active Projects</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/freelancers') ? 'menu__list-link--active' : ''}`} to="/freelancers">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16 21V19C16 17.9391 15.5786 16.9217 14.8284 16.1716C14.0783 15.4214 13.0609 15 12 15H6C4.93913 15 3.92172 15.4214 3.17157 16.1716C2.42143 16.9217 2 17.9391 2 19V21" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <path d="M22 21V19C21.9993 18.1137 21.7044 17.2528 21.1614 16.5523C20.6184 15.8519 19.8581 15.3516 19 15.13" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.0078 6.11683 19.0078 7.005C19.0078 7.89318 18.7122 8.75608 18.1676 9.45769C17.623 10.1593 16.8604 10.6597 16 10.88" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span>Freelancers</span>
            </Link>
            <div className="popup_menu">Freelancers</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/leaderboard') ? 'menu__list-link--active' : ''}`} to="/leaderboard">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22 10V16M22 10L12 5L2 10L12 15L22 10Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6 12V17C9 20 15 20 18 17V12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span>Leaderboard</span>
            </Link>
            <div className="popup_menu">Leaderboard</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/disputes') ? 'menu__list-link--active' : ''}`} to="/disputes">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="popup_menu">Disputes</div>
          </li>
          <li className="menu__list-item">
            <Link className={`menu__list-link ${isActive('/how-it-works') ? 'menu__list-link--active' : ''}`} to="/how-it-works">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 18V18.01M8 10C8 7.79086 9.79086 6 12 6C14.2091 6 16 7.79086 16 10C16 11.8675 14.7202 13.4361 12.9899 13.8766C12.4547 14.0128 12 14.4477 12 15M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12Z" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              <span>How It Works</span>
            </Link>
            <div className="popup_menu">How It Works</div>
          </li>
        </ul>
      </nav>
    </aside>
